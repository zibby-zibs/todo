  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#3F5BF6] text-[#3F5BF6] hover:bg-[#3F5BF6] hover:text-neutral-50 focus:bg-[#3F5BF6] focus:text-neutral-50 dark:bg-[#3F5BF6] dark:text-neutral-900 dark:hover:bg-[#3F5BF6] dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
